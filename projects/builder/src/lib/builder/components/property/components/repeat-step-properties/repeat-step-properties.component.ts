...
@Component({
  selector: 'lib-repeat-step-properties',
  templateUrl: './repeat-step-properties.component.html',
  styleUrls: ['./repeat-step-properties.component.css']
})
export class RepeatStepPropertiesComponent implements OnInit, OnChanges {

  @Input() selectedElement: any;
  AuditTypes: typeof AuditTypes = AuditTypes;
  constructor(private controlService: ControlService, public auditService: AuditService, 
