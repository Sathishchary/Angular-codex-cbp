...
export class AngularDraggableDirective implements OnInit, OnDestroy, OnChanges, AfterViewInit {
  ...
  ngOnDestroy() {
    ...
    this.orignal = null as any;
    this.oldTrans = null as any;
    this.tempTrans = null as any;
    this.currTrans = null as any;
  ...
  checkHandleTarget(target: any, element: Element) {
